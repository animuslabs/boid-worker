...
import { daysInMonth, ymd2ord, ord2ymd, daysBeforeMonth, isLeapYear, } from "./dateutil";
...
export class LocalDate {
    ...
    get dayOfYear() {
        return (daysBeforeMonth(this._date.getUTCFullYear(), this._date.getUTCMonth() + 1) + this._date.getUTCDate());
    }
    get daysInWeek() {
        return 7;
    }
    get daysInMonth() {
        return daysInMonth(this._date.getUTCFullYear(), this._date.getUTCMonth() + 1);
    }
    get daysInYear() {
...
export function LocalDateToOrdinal(localdate) {
    return ymd2ord(localdate.year, localdate.month, localdate.day);
}
export function LocalDateFromOrdinal(ordinal) {
...
export function parseHumanDurationString(durationStr) {

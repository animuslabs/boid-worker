...
export class Int64Codec extends ScalarCodec {
    encode(buf, object) {
...
export class Int64BigintCodec extends ScalarCodec {
    encode(buf, object) {
...
export class Int32Codec extends ScalarCodec {
    encode(buf, object) {
        if (typeof object !== "number") {
            throw new InvalidArgumentError(`a number was expected, got "${object}"`);
        }
...
export class Int16Codec extends ScalarCodec {
    encode(buf, object) {
        if (typeof object !== "number") {
            throw new InvalidArgumentError(`a number was expected, got "${object}"`);
        }
...
export class Float32Codec extends ScalarCodec {
    encode(buf, object) {
        if (typeof object !== "number") {
            throw new InvalidArgumentError(`a number was expected, got "${object}"`);
        }
...
export class Float64Codec extends ScalarCodec {
    encode(buf, object) {
        if (typeof object !== "number") {
            throw new InvalidArgumentError(`a number was expected, got "${object}"`);
        }

...
export async function getTypes(cxn, params) {
    var _a, _b;
        ...
        switch (type.kind) {
            ...
            case "range":
                type.range_element_id =
                    (_b = (_a = typeMapping.get(type.range_element_id)) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : type.range_element_id;
                break;
            case "array":
                break;
            case "tuple":
...
export function topoSort(types) {
    const graph = new StrictMap();
    const adj = new StrictMap();
    for (const type of types) {

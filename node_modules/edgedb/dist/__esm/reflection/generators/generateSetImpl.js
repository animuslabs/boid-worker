...
export const generateSetImpl = ({ dir, types, casts }) => {
...
>(expr: Expr): $expr_Set<castMaps.literalToTypeSet<Expr>>;`,
    ...
    for (const implicitRootTypeId of implicitCastableRootTypes) {
        code.writeln([
            dts `declare `,
            t `function set<
  Expr extends castMaps.orScalarLiteral<$.TypeSet<${getStringRepresentation(types.get(implicitRootTypeId), {
                types,
...
>(...exprs: Exprs): $expr_Set<getSetTypeFromExprs<castMaps.mapLiteralToTypeSet<Exprs>>>;`,
        ...
        code.writeln([
            dts `declare `,
            t `function set<
  Expr extends $.TypeSet<$.ArrayType<${getStringRepresentation(types.get(implicitRootTypeId), {
                types,
                casts: casts.implicitCastFromMap,
            }).staticType}>>,
  Exprs extends [Expr, ...Expr[]]
